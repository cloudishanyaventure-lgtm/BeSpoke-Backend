...
public record CompanyDto(
    ...
    public static CompanyDto from(Company company, List<String> missingKyc,
        ...
        return new CompanyDto(company.getId(), company.getName(), company.getSlug(),
                ...
                java.util.Map.copyOf(company.getPortfolioSections()),
                ...
                company.getOfficeAddress(), company.getGstSameAsOffice(),
                company.getFeaturedDesignerId(), List.copyOf(company.getVendorCategories()),
